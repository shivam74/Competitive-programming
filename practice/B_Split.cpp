...
void solve(){
    ...
    ll cntOdd=0,cntEven2=0,cntEven4=0;
    for(auto x: mp){
        if(x.second%2==1)cntOdd++;
        else if(x.second%4==0)cntEven4++;
        else cntEven2++;
    }
    if(cntOdd>0LL || cntEven4%2==0){
        cout<<cntOdd+2*cntEven2+2*cntEven4<<endl;
    }
    else{
        cout<<cntOdd+2*cntEven2+2*cntEven4 -2<<endl;
    }
}
